...
public class Bai4 {
    public static void main(String[] args){
        ...
        System.out.printf("Điểm trung bình: %.2f%n", CalculatedAverage(scores));
        System.out.println("Số học sinh có điểm trung bình (<5.0): " + CountFailedStudents(scores));
    }
    ...
    public static double CalculatedAverage(double[] arr){
        double sum=0;
